package danilobarreto.dev.systemapiauth.config;

import danilobarreto.dev.systemapiauth.security.CustomUserDetailsService;
import danilobarreto.dev.systemapiauth.security.JwtAuthenticationEntryPoint;
import danilobarreto.dev.systemapiauth.security.JwtAuthenticationFilter;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                .authorizeHttpRequests(registry -> {
                    ...
                    registry.requestMatchers("/api/project/**").permitAll();
                    registry.requestMatchers("/api/finance/**").permitAll();
